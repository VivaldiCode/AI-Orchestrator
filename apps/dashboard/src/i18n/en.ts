...
export const en = {
  ...
  'nav.debug': 'Debug',
  'debug.title': 'Debug',
  'debug.subtitle': 'Recent requests and why they failed — expand a row for the raw request/response.',
  ...
  'debug.filterByIp': 'Filter by IP',
  'debug.filterByProvider': 'Filter by provider',
  'debug.filterByModel': 'Filter by model',
  'debug.filterByEndpoint': 'Filter by endpoint',
  'debug.filterByStatus': 'Status',
  'debug.clearFilters': 'Clear filters',
  'debug.clientIp': 'Client IP',
  'debug.servedBy': 'Served by',
  'debug.tokens': 'Tokens (prompt / completion)',
  'debug.time': 'Time',
  ...
  'settings.requestLogMax': 'Max saved requests (cyclic)',
  'settings.requestLogMaxHint':
    'Keep only the most recent N requests in the log (oldest trimmed). 0 = unlimited. E.g. 100000 or 1000000.',
