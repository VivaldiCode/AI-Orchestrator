...
export const pt: Dict = {
  ...
  'nav.debug': 'Debug',
  'debug.title': 'Debug',
  'debug.subtitle': 'Pedidos recentes e porque falharam — expande uma linha para ver o request/response cru.',
  'debug.errorsOnly': 'Só erros',
  'debug.noEvents': 'Ainda sem pedidos registados.',
  'debug.bodiesUnavailable': 'Corpos indisponíveis (ativa o archive de pedidos para os capturar).',
  'debug.sentToProvider': 'Modelo realmente enviado ao provedor',
  'debug.filterByIp': 'Filtrar por IP',
  'debug.filterByProvider': 'Filtrar por provedor',
  'debug.filterByModel': 'Filtrar por modelo',
  'debug.filterByEndpoint': 'Filtrar por endpoint',
  'debug.filterByStatus': 'Status',
  'debug.clearFilters': 'Limpar filtros',
  'debug.clientIp': 'IP do cliente',
  'debug.servedBy': 'Resolvido por',
  'debug.tokens': 'Tokens (prompt / resposta)',
  'debug.time': 'Hora',
  'debug.requestId': 'ID da requisição',
  ...
  'nodes.editEndpoint': 'Clique para editar o endpoint',
  'nodes.save': 'Guardar',
  'nodes.saving': 'A guardar…',
  'nodes.cancel': 'Cancelar',
  'nodes.editError': 'Falha ao atualizar o nó',
  ...
  'providers.notFound': 'Provedor não encontrado',
  'providers.balanceTitle': 'Saldo da conta',
  'providers.balanceLive': 'ao vivo',
  'providers.balanceUnavailable': 'Saldo indisponível via API',
  'providers.cost': 'Custo',
  'providers.requests': 'Pedidos',
  'providers.tokens': 'Tokens',
  'providers.avgLatency': 'Latência média',
  'providers.byModel': 'Por modelo',
  'providers.promptsTitle': 'Prompts enviados aqui',
  'providers.noPrompts': 'Ainda sem prompts arquivados para este provedor.',
  'providers.request': 'Pedido',
  'providers.response': 'Resposta',
  'providers.localOllama': 'Local (Ollama)',
  'providers.localHint': 'Histórico de prompts e custo do teu cluster local',
  ...
  'providers.equivModelManual': '✏️ Digitar manualmente…',
  'providers.equivPickFromList': 'Escolher do catálogo',
  'providers.equivModelHint':
    'Use o nome do modelo no próprio provedor (ex.: grok-2-latest, gpt-4o) — não o nome do modelo local.',
  ...
  'providers.subscriptionCreateHint':
    'Cria o provider e depois liga a tua subscrição xAI no cartão dele.',
  'providers.subscription': 'Subscrição xAI',
  'providers.connected': 'Ligado',
  'providers.notConnected': 'Não ligado',
  'providers.connect': 'Ligar subscrição',
  ...
  'providers.subscriptionError': 'Falha na ação de subscrição',
  'playground.title': 'Playground de Queries',
  'playground.subtitle':
  ...
  'playground.userMessage': 'Mensagem do utilizador',
  'playground.userPlaceholder': 'Pergunta algo…',
  'playground.temperature': 'Temperature',
  'playground.maxTokens': 'Máx. tokens',
  'playground.send': 'Enviar pedido',
  'playground.sending': 'A enviar…',
  'playground.response': 'Resposta',
  'playground.servedBy': 'Servido por',
  'playground.latency': 'Latência',
  'playground.tokens': 'Tokens (in → out)',
  'playground.status': 'Status',
  'playground.requestBody': 'Corpo do pedido',
  'playground.rawResponse': 'Resposta crua',
  'playground.noResponse': 'Envia um pedido para ver a resposta aqui.',
  'playground.noText': 'Sem conteúdo de texto na resposta.',
  'playground.requestError': 'Falha no pedido do playground',
  ...
  'settings.requestLogMax': 'Máx. de requests salvas (cíclico)',
  'settings.requestLogMaxHint':
    'Mantém só as N requisições mais recentes no log (as mais antigas são removidas). 0 = ilimitado. Ex.: 100000 ou 1000000.',
  ...
  'settings.embedOverflowSelect': 'Selecione um provedor',
  'settings.embedOverflowModel': 'Modelo de embedding',
  'settings.embedOverflowHint':
    'Desligado por padrão — embeddings carregam o seu conteúdo. Escolha um provedor compatível com OpenAI e o modelo de embedding dele (ex.: text-embedding-3-small).',
